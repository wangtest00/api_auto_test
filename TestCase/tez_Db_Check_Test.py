...
class Tez_Db_Check_Test(unittest.TestCase):
    ...
    def test_check_withdraw_success(self):
        ...
        self.assertEqual(t2,[('950.00', '10420002')])
        t3=cx_pay_tran_dtl(loan_no,'10330001')
        self.assertEqual(t3,[('10320003', '10330001', 'C', '950.00', '10220002')])
        ...
        self.assertEqual(t7,[('50.00', '10440001', '10350002')])
        t8=cx_fin_ad_dtl(loan_no)
        repay_date=jisuan_repay_date(loan_no)
        self.assertEqual(t8,[(repay_date[0], '50.00', '10360002', '10370001', '10440001')])
        t9=cx_fin_ad_detail_dtl(loan_no)
        self.assertEqual(t9,[(repay_date[0], '14', '50.00', '10370001', '10440001')])
        t10=cx_fin_rc_dtl(loan_no)
        self.assertEqual(t10,[('950.00', '10440002', '10390002')])
    @classmethod
