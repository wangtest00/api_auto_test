...
class FR_Db_Check_Test(unittest.TestCase):
    ...
    def test_check_repayment_jieqing(self):
        '''【FeriaRapida】还款结清后，相关11个表关键字段值核对-正案例'''
        loan_no=cx_yijieqing_loan_no()
        print(loan_no)
        t1=cx_lo_loan_dtl(loan_no)
        self.assertEqual(t1[0][:5],('1000.00', '1000.00', '1', '10260005', '10270005'))
        ...
        self.assertEqual(t4,('25002400', '25002400'))
        t5=cx_dc_flow_dtl(loan_no)
        self.assertEqual(t5,[('1001', '1', '1000.00', 'C'), ('1002', '1', '1000.00', 'D'), ('1201', '1', '120.00', 'C'), ('1202', '1', '120.00', 'D'), ('1401', '1', '100.00', 'C'), ('1402', '1', '100.00', 'D'), ('2101', '1', '100.00', 'C'), ('2102', '1', '100.00', 'D'), ('2301', '1', '20.00', 'C'), ('2302', '1', '20.00', 'D'), ('2401', '1', '50.00', 'C'), ('2402', '1', '50.00', 'D')])
        t6=cx_lo_loan_plan_dtl(loan_no)
        repay_date=jisuan_repay_date(loan_no)
        self.assertEqual(t6,((1, repay_date[0], '10270005'),))
        t7=cx_fin_ac_dtl(loan_no)
        self.assertEqual(t7,[('250.00', '10440001', '10350002')])
        t8=cx_fin_ad_dtl(loan_no)
        self.assertEqual(t8,[])
